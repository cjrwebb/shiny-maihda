...
bs4DashPage(
                 ...
                 fluidRow(
                   ...
                   column(width = 8,
                          ...
                          HTML('<div class="sans-serif">This tool allows you to explore estimates from a MAIHDA model — where level 2 units have been defined based on combinations of other variables. For more on how to use these models, see this <a href="https://www.sciencedirect.com/science/article/pii/S235282732400065X" target="_blank">tutorial paper</a>.<br><br>
                               ...
                               To cite the app, please use the following citation: Webb, C. and Bell, A. (2026). <em>Interactive tool for exploring MAIHDA strata predictions.</em> Available at <a href="https://webb.shinyapps.io/maihda-cocoon/" target="_blank">https://webb.shinyapps.io/maihda-cocoon/</a>. doi: 10.15131/shef.data.32925566. <a href="https://github.com/cjrwebb/shiny-maihda" target="_blank">Source code.</a><br><br></div>')
                   ),
                   column(width = 2)
                 ),
  ...
  footer = dashboardFooter(left = a(href = "https://intersectionalhealth.org/",
                                    target = "_blank", HTML("<em>IntersectionalHealth.org/</em> (2026-)")), right = HTML('Created by <a href="https://calumwebb.co.uk/calum.html" target="_blank"><em>Dr. Calum Webb</em></a>, University of Sheffield'), fixed = TRUE))
